...
RSpec.describe Legion::Extensions::Agentic::Inference::Coherence::Runners::CognitiveCoherence do
  let(:client) { Legion::Extensions::Agentic::Inference::Coherence::Client.new }
  ...
  describe '#add_coherence_proposition' do
    ...
    it 'uses default acceptance when none provided' do
      ...
      expect(result[:acceptance]).to eq(Legion::Extensions::Agentic::Inference::Coherence::Helpers::Constants::DEFAULT_ACCEPTANCE)
    end
