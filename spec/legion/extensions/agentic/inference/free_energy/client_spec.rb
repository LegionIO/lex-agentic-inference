...
RSpec.describe Legion::Extensions::Agentic::Inference::FreeEnergy::Client do
  ...
  describe 'with injected engine' do
    it 'uses the provided engine' do
      engine = Legion::Extensions::Agentic::Inference::FreeEnergy::Helpers::FreeEnergyEngine.new
