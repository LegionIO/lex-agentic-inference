...
RSpec.describe Legion::Extensions::Agentic::Inference::PerceptualInference::Helpers::PerceptualField do
  ...
  describe '#register_hypothesis' do
    it 'returns a PerceptualHypothesis' do
      ...
      expect(h).to be_a(Legion::Extensions::Agentic::Inference::PerceptualInference::Helpers::PerceptualHypothesis)
    end
  ...
  describe '#present_evidence' do
    ...
    it 'caps evidence log at MAX_EVIDENCE' do
      ...
      expect(field.evidence_log.size).to be <= Legion::Extensions::Agentic::Inference::PerceptualInference::Helpers::MAX_EVIDENCE
    end
  end
