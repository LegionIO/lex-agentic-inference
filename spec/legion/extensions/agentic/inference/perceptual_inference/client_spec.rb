...
RSpec.describe Legion::Extensions::Agentic::Inference::PerceptualInference::Client do
  ...
  it 'accepts an injected PerceptualField' do
    custom_field = Legion::Extensions::Agentic::Inference::PerceptualInference::Helpers::PerceptualField.new
