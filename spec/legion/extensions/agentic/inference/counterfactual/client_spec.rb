...
RSpec.describe Legion::Extensions::Agentic::Inference::Counterfactual::Client do
  ...
  it 'accepts an injected engine' do
    fake_engine = Legion::Extensions::Agentic::Inference::Counterfactual::Helpers::CounterfactualEngine.new
