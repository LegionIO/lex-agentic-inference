...
RSpec.describe Legion::Extensions::Agentic::Inference::Counterfactual::Helpers::Constants do
  subject(:klass) do
    Class.new { include Legion::Extensions::Agentic::Inference::Counterfactual::Helpers::Constants }
  end
