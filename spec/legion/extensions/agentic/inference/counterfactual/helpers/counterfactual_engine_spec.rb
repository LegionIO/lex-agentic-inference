...
RSpec.describe Legion::Extensions::Agentic::Inference::Counterfactual::Helpers::CounterfactualEngine do
  ...
  describe '#generate' do
    it 'returns a Scenario instance' do
      ...
      expect(result).to be_a(Legion::Extensions::Agentic::Inference::Counterfactual::Helpers::Scenario)
    end
  ...
  describe '#generate_alternatives' do
    it 'returns an array of scenarios' do
      ...
      expect(result).to all(be_a(Legion::Extensions::Agentic::Inference::Counterfactual::Helpers::Scenario))
    end
