...
RSpec.describe Legion::Extensions::Agentic::Inference::Magnet::Helpers::MagnetEngine do
  ...
  describe '#create_pole' do
    it 'creates and stores a pole' do
      ...
      expect(result).to be_a(Legion::Extensions::Agentic::Inference::Magnet::Helpers::Pole)
    ...
    it 'returns error when at capacity' do
      stub_const('Legion::Extensions::Agentic::Inference::Magnet::Helpers::Constants::MAX_POLES', 1)
  ...
  describe '#create_field' do
    it 'creates and stores a field' do
      ...
      expect(result).to be_a(Legion::Extensions::Agentic::Inference::Magnet::Helpers::Field)
      expect(engine.fields.size).to eq(1)
    end

    it 'returns error when at field capacity' do
      stub_const('Legion::Extensions::Agentic::Inference::Magnet::Helpers::Constants::MAX_FIELDS', 1)
