...
require 'legion/extensions/agentic/inference/magnet/client'

RSpec.describe Legion::Extensions::Agentic::Inference::Magnet::Runners::CognitiveMagnet do
  let(:client) { Legion::Extensions::Agentic::Inference::Magnet::Client.new }
  let(:engine) { Legion::Extensions::Agentic::Inference::Magnet::Helpers::MagnetEngine.new }
  ...
  describe '#create_pole' do
    ...
    it 'includes valid_polarities in error response' do
      result = client.create_pole(polarity: :zap, content: 'x')
      expect(result[:valid_polarities]).to eq(Legion::Extensions::Agentic::Inference::Magnet::Helpers::Constants::POLARITY_TYPES)
    end
