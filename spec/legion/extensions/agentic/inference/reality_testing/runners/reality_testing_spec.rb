...
RSpec.describe Legion::Extensions::Agentic::Inference::RealityTesting::Runners::RealityTesting do
  let(:client) { Legion::Extensions::Agentic::Inference::RealityTesting::Client.new }
