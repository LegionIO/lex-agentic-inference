...
RSpec.describe Legion::Extensions::Agentic::Inference::RealityTesting::Helpers::RealityEngine do
  ...
  describe '#create_belief' do
    ...
    it 'returns at_capacity when MAX_BELIEFS reached' do
      stub_const('Legion::Extensions::Agentic::Inference::RealityTesting::Helpers::Constants::MAX_BELIEFS', 2)
