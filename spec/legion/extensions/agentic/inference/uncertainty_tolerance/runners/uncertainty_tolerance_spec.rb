...
RSpec.describe Legion::Extensions::Agentic::Inference::UncertaintyTolerance::Runners::UncertaintyTolerance do
  let(:client) { Legion::Extensions::Agentic::Inference::UncertaintyTolerance::Client.new }
