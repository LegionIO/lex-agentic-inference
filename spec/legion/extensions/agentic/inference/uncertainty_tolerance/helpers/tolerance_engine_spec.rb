...
RSpec.describe Legion::Extensions::Agentic::Inference::UncertaintyTolerance::Helpers::ToleranceEngine do
  subject(:engine) { described_class.new }

  describe '#initialize' do
    it 'starts at DEFAULT_TOLERANCE' do
      expect(engine.current_tolerance).to eq(
        Legion::Extensions::Agentic::Inference::UncertaintyTolerance::Helpers::Constants::DEFAULT_TOLERANCE
      )
    end
  ...
  describe '#record_decision' do
    ...
    it 'returns a Decision object' do
      ...
      expect(result).to be_a(Legion::Extensions::Agentic::Inference::UncertaintyTolerance::Helpers::Decision)
    end
  ...
  describe '#risk_profile' do
    it 'returns a hash keyed by decision types' do
      ...
      expect(profile.keys).to match_array(
        Legion::Extensions::Agentic::Inference::UncertaintyTolerance::Helpers::Constants::DECISION_TYPES
      )
    end
