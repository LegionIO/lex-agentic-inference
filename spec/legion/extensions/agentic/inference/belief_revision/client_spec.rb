...
RSpec.describe Legion::Extensions::Agentic::Inference::BeliefRevision::Client do
  ...
  it 'accepts injected network' do
    network = Legion::Extensions::Agentic::Inference::BeliefRevision::Helpers::BeliefNetwork.new
