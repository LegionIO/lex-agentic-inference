...
RSpec.describe Legion::Extensions::Agentic::Inference::BeliefRevision::Helpers::Belief do
  subject(:belief) do
  ...
  describe '#add_supporting_evidence' do
    it 'increases credence' do
      ev = Legion::Extensions::Agentic::Inference::BeliefRevision::Helpers::Evidence.new(
