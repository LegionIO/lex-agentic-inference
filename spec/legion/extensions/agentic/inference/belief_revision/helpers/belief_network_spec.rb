...
RSpec.describe Legion::Extensions::Agentic::Inference::BeliefRevision::Helpers::BeliefNetwork do
  ...
  describe '#add_belief' do
    it 'creates a belief' do
      ...
      expect(belief).to be_a(Legion::Extensions::Agentic::Inference::BeliefRevision::Helpers::Belief)
