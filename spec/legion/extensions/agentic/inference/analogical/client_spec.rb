...
RSpec.describe Legion::Extensions::Agentic::Inference::Analogical::Client do
  ...
  it 'accepts an injected engine' do
    custom_engine = Legion::Extensions::Agentic::Inference::Analogical::Helpers::AnalogyEngine.new
