...
RSpec.describe Legion::Extensions::Agentic::Inference::Analogical::Helpers::StructureMap do
  ...
  describe '#initialize' do
    ...
    it 'sets default strength' do
      expect(structure_map.strength).to eq(Legion::Extensions::Agentic::Inference::Analogical::Helpers::Constants::DEFAULT_STRENGTH)
    end
    ...
    it 'clamps custom strength to ceiling' do
      ...
      expect(map.strength).to eq(Legion::Extensions::Agentic::Inference::Analogical::Helpers::Constants::STRENGTH_CEILING)
    end
    ...
    it 'clamps custom strength to floor' do
      ...
      expect(map.strength).to eq(Legion::Extensions::Agentic::Inference::Analogical::Helpers::Constants::STRENGTH_FLOOR)
    end
  ...
  describe '#reinforce' do
    it 'increases strength by reinforcement rate' do
      ...
      expect(structure_map.strength).to be_within(0.001).of(
        (initial + Legion::Extensions::Agentic::Inference::Analogical::Helpers::Constants::REINFORCEMENT_RATE)
          .clamp(
            Legion::Extensions::Agentic::Inference::Analogical::Helpers::Constants::STRENGTH_FLOOR,
            Legion::Extensions::Agentic::Inference::Analogical::Helpers::Constants::STRENGTH_CEILING
          )
      )
    end
    ...
    it 'does not exceed strength ceiling' do
      map = described_class.new(
        source_domain: :a, target_domain: :b, mappings: {}, mapping_type: :attribute,
        strength: Legion::Extensions::Agentic::Inference::Analogical::Helpers::Constants::STRENGTH_CEILING
      )
  ...
  describe '#weaken' do
    ...
    it 'does not drop below strength floor' do
      map = described_class.new(
        source_domain: :a, target_domain: :b, mappings: {}, mapping_type: :attribute,
        strength: Legion::Extensions::Agentic::Inference::Analogical::Helpers::Constants::STRENGTH_FLOOR
      )
  ...
  describe '#decay' do
    it 'reduces strength by decay rate' do
      ...
      structure_map.decay
      expect(structure_map.strength).to be_within(0.001).of(
        (initial - Legion::Extensions::Agentic::Inference::Analogical::Helpers::Constants::DECAY_RATE)
          .clamp(
            Legion::Extensions::Agentic::Inference::Analogical::Helpers::Constants::STRENGTH_FLOOR,
            Legion::Extensions::Agentic::Inference::Analogical::Helpers::Constants::STRENGTH_CEILING
          )
