...
RSpec.describe Legion::Extensions::Agentic::Inference::Analogical::Helpers::AnalogyEngine do
  ...
  describe '#create_analogy' do
    it 'creates and returns a StructureMap' do
      ...
      expect(analogy).to be_a(Legion::Extensions::Agentic::Inference::Analogical::Helpers::StructureMap)
    end
